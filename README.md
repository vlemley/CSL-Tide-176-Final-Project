...
The first variable that we decided to look at was tide height. Large amounts of dry land are most accessable during low tide. Not only is it less energetically expensive for CSL to jump from the water to the land during low tide, but it also exposes more viable land for them to occupy. A greater amount of available space allows room for larger groups of animals to gather and reduces competition. 
...
Tide Height: We used NOAA tide charts from the Ano Nuevo Island monitoring location. We extracted the low and high tides for each day from May-August 2025 onto a seperate spreadsheet (tides.csv). 

Solar Radiation: We used data from the DENDRA station at Ano Nuevo. It collects a wide variety of meteorelogical data every 10 minutes and we extracted the average solar radiation levels from May-August 2025 (Solar_Radiation. csv)
...
1) Avergage solar radiation levels from May-August was extrated from the DENDRA Ano Nuevo portal.

2) Rounded the times of the surveys on the tide and branded CSL data sheets to the nearest 10 minutes to align with solar radiaiton data

3) Combined CSL data, tide height, and solar radiation levels onto one sheet
